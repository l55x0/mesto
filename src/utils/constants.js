...
export const popupFormEditContainer =
  document.querySelector('#popup-form-edit');
export const popupFormAddAvatarContainer = document.querySelector(
  '#popup-form-add-avatar'
);

// Выбираем елементы форм
export const popupNameField = document.querySelector(
  '.popup__input_type_author'
);
export const popupStatusField = document.querySelector(
...
export const profileSubtitleContainer =
  document.querySelector('.profile__status');
